...
# https://docs.nextcloud.com/server/20/admin_manual/configuration_server/occ_command.html?highlight=occ#command-line-installation-label

wget -O- https://github.com/nextcloud/server/archive/v20.0.0.tar.gz | tar -xz --strip-components=1
...
wget -O- https://github.com/nextcloud/3rdparty/archive/v20.0.0.tar.gz | tar -C 3rdparty -xz --strip-components=1
