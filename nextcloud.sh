...
wget -O- https://github.com/nextcloud/server/archive/v21.0.1.tar.gz | tar -xz --strip-components=1
...
wget -O- https://github.com/nextcloud/3rdparty/archive/v21.0.1.tar.gz | tar -C 3rdparty -xz --strip-components=1
