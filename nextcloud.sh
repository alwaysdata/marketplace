...
wget -O- https://github.com/nextcloud/server/archive/v24.0.2.tar.gz | tar -xz --strip-components=1
...
wget -O- https://github.com/nextcloud/3rdparty/archive/v24.0.2.tar.gz | tar -C 3rdparty -xz --strip-components=1
