...
#         regex: ^[a-zA-Z0-9.'`* _-]+$
#         regex_text:
#             en: "It can include uppercase, lowercase, numbers, and special characters: .'`* _-."
#             fr: "Il peut comporter des majuscules, des minuscules, des chiffres et les caractères spéciaux : .'`* _-."
#     admin_lastname:
#         label:
...
export PRESTASHOP_VERSION="8.2.8"
...
# Download
wget -O- --no-hsts https://github.com/PrestaShop/PrestaShop/releases/download/8.2.8/prestashop_$PRESTASHOP_VERSION.zip | bsdtar --strip-components=0 -xf -
