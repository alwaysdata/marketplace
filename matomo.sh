...
cd plugins
wget -O- --no-hsts https://github.com/digitalist-se/extratools/archive/refs/tags/5.1.1.zip | bsdtar --strip-components=0 -xf -
mv Matomo-Plugin-ExtraTools-5.1.1 ExtraTools
cd
