...
# Download
wget -O- --no-hsts https://builds.matomo.org/matomo-5.2.1.zip | bsdtar --strip-components=1 -xf -

# https://plugins.matomo.org/ExtraTools#documentation
cd plugins
wget -O- --no-hsts https://github.com/digitalist-se/extratools/archive/refs/tags/5.1.0.zip | bsdtar --strip-components=0 -xf -
mv Matomo-Plugin-ExtraTools-5.1.0 ExtraTools
cd
